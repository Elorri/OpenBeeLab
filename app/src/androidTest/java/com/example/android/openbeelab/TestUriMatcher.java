...
import com.example.android.openbeelab.db.BeeContract.ApiaryEntry;
...
public class TestUriMatcher extends AndroidTestCase {
    private static final String USER_ID = "la_mine";
    ...
    public void testUriMatcher() {
        ...
        uri = ApiaryEntry.buildApiariesViewUri(USER_ID);
        Log.e("jj", uri.toString());
        assertEquals("Error:", testMatcher.match(uri), BeeProvider.USER_APIARIES);
    }
}
